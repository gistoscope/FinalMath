...
import { AstNode, AstParser, AstUtils } from "@/core/ast";
...
export class AstPatternService {
   ...
   */
  private evaluateCalc(expr: string, bindings: Record<string, any>): number | null {
    let evalExpr = expr;
   ...
   */
  private substituteVariables(node: AstNode, bindings: Record<string, any>): AstNode {
