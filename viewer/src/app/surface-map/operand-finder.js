...
/**
 * Find operand surface nodes for a given operator AST path.
 * @param {Object} surfaceMap - Surface map
 * @param {string} operatorAstPath - AST path
 * @returns {{left: Object|null, right: Object|null}|null}
 */
