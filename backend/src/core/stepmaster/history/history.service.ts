...
import { StepHistory, StepHistoryEntry, StepHistoryUpdateData } from "./history.types.js";
...
export class StepHistoryService {
  ...
  updateLastStep(history: StepHistory, data: Partial<StepHistoryUpdateData>): StepHistory {
    ...
    if (data.expressionAfter !== undefined) lastEntry.expressionAfter = data.expressionAfter;
    if (data.expressionBefore !== undefined) lastEntry.expressionBefore = data.expressionBefore;
    if (data.invariantRuleId !== undefined) lastEntry.invariantRuleId = data.invariantRuleId;
    if (data.targetPath !== undefined) lastEntry.targetPath = data.targetPath;
    if (data.primitiveIds !== undefined) lastEntry.primitiveIds = data.primitiveIds;
