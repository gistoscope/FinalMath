 ...
 *
 * Central export point for all request handler classes.
 */
...
export { LegacyCandidateHandler } from "./legacy-candidate.handler.js";
export type { LegacyCandidateResult } from "./legacy-candidate.handler.js";
