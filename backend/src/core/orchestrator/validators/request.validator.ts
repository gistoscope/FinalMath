...
import type { InvariantRegistry } from "@/core/invariants/InvariantRegistry.js";
...
export class RequestValidator {
  ...
  validate(req: OrchestratorStepRequest): ValidationResult {
    ...
    if (req.userRole && !["student", "teacher", "admin"].includes(req.userRole)) {
      return {
        isValid: false,
   ...
   * @returns Validation result
   */
  validateCourseId(courseId: string, registry: InvariantRegistry): ValidationResult {
   ...
   * @returns Validation result
   */
  validateSelectionPath(selectionPath: string | null | undefined): ValidationResult {
   ...
   * @returns Validation result
   */
  validateOperatorIndex(operatorIndex: number | null | undefined): ValidationResult {
