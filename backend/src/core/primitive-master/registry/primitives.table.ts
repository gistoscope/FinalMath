...
export interface IPrimitivesTable {
  version: string;
  rows: PrimitiveRow[];
}
...
export const PRIMITIVES_V5_TABLE: IPrimitivesTable = {
  version: "v5.0.0",
  rows: [
    {
      id: "P.INT_ADD",
    ...
    },
    {
      ...
      actionClass: "normal",
      label: "Int (Left) + Frac",
      enginePrimitiveId: "P.INT_PLUS_FRAC_LEFT",
      operandTypes: { left: "int", right: "any" },
      notes: "Convert left integer to fraction for addition",
    },
    {
      id: "P.INT_PLUS_FRAC_RIGHT",
      domain: "mixed",
      category: "Mixed Operations",
      clickTargetKind: "operator",
      operatorLatex: "+",
      ...
      uiMode: "auto-apply",
      actionClass: "normal",
      label: "Frac + Int (Right)",
      enginePrimitiveId: "P.INT_PLUS_FRAC_RIGHT",
      operandTypes: { left: "any", right: "int" },
      notes: "Convert right integer to fraction for addition",
    },
    {
      id: "P.INT_MINUS_FRAC_LEFT",
      domain: "mixed",
      category: "Mixed Operations",
      clickTargetKind: "operator",
      operatorLatex: "-",
      ...
      actionClass: "normal",
      label: "Int (Left) - Frac",
      enginePrimitiveId: "P.INT_MINUS_FRAC_LEFT",
      operandTypes: { left: "int", right: "any" },
      notes: "Convert left integer to fraction for subtraction",
    },
    {
      id: "P.INT_MINUS_FRAC_RIGHT",
      domain: "mixed",
      category: "Mixed Operations",
      clickTargetKind: "operator",
      operatorLatex: "-",
      ...
      actionClass: "normal",
      label: "Frac - Int (Right)",
      enginePrimitiveId: "P.INT_MINUS_FRAC_RIGHT",
      operandTypes: { left: "any", right: "int" },
      notes: "Convert right integer to fraction for subtraction",
    },
    {
      id: "P.DECIMAL_DIV",
    ...
    },
    {
      ...
      clickTargetKind: "operator",
      operatorLatex: "*",
      operandTypes: { left: "int", right: "fraction" },
      color: "green",
      uiMode: "auto-apply",
      actionClass: "normal",
      label: "Integer by Fraction Multiplication",
      enginePrimitiveId: "P.FRAC_MUL",
      notes: "Multiply int by fraction. Constraints: a,b,c ∈ ℤ; c≠0",
    },
    {
      id: "P.FRAC_MUL_INT",
      domain: "fractions",
      ...
      clickTargetKind: "operator",
      operatorLatex: "*",
      operandTypes: { left: "fraction", right: "int" },
      color: "green",
      uiMode: "auto-apply",
      actionClass: "normal",
      label: "Fraction by Integer Multiplication",
      enginePrimitiveId: "P.FRAC_MUL",
      notes: "Multiply fraction by int. Constraints: a,b,c ∈ ℤ; b≠0",
    },
    {
      ...
      clickTargetKind: "operator",
      operatorLatex: "\\div",
      operandTypes: { left: "any", right: "fraction" },
      color: "green",
      uiMode: "auto-apply",
      actionClass: "normal",
...
@injectable()
export class IPrimitivesTable {
  constructor() {}

  // getPrimitiveDef(id: PrimitiveId): PrimitiveRow | undefined {
  //   return PRIMITIVES_V5_TABLE.rows.find((r) => r.id === id);
  // }
}
