 ...
 */
export function isLocalToSelection(selectionPath, selectionAstPath, candidate) {
 ...
 */
export function getOperatorAnchorPath(ast, // AstNode
selectionAstPath, selectionPath, operatorIndex, getNodeAt) {
