 ...
 */
export const FRAC_ADD_SAME_DEN_STAGE1 = {
    ...
    isMatch(ctx) {
        if (ctx.nodeKind !== "binaryOp" || ctx.op !== "+")
            return false;
        if (!ctx.leftIsFraction || !ctx.rightIsFraction)
            return false;
        // Check denominators
        const left = ctx.left;
...
export const FRAC_SUB_SAME_DEN_STAGE1 = {
...
export const FRACTIONS_SAME_DEN_PRIMITIVES = [
