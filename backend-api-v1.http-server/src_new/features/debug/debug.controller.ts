...
export class DebugController {
  ...
  async astDebug(req: Request, res: Response) {
    ...
    const result = await this.debugService.handleAstDebug(dto);
  ...
  async mapMasterDebug(req: Request, res: Response) {
    ...
    const result = await this.debugService.handleMapMasterDebug(dto);
  ...
  async mapMasterGlobalMap(req: Request, res: Response) {
    ...
    const result = await this.debugService.handleMapMasterGlobalMap(dto);
  ...
  async stepDebug(req: Request, res: Response) {
    ...
    const result = await this.debugService.handleStepDebug(dto);
  ...
  async instrument(req: Request, res: Response) {
    ...
    const result = await this.debugService.handleInstrument(dto);
  ...
  async validateOperator(req: Request, res: Response) {
    ...
    const result = await this.debugService.handleValidateOperator(dto);
...
export class DebugTraceController {
  ...
  async getLatestStepSnapshot(_req: Request, res: Response) {
    const snapshot = this.debugService.getLatestStepSnapshot();
  ...
  async getSessionStepSnapshots(_req: Request, res: Response) {
    const snapshots = this.debugService.getSessionStepSnapshots();
  ...
  async resetStepSnapshotSession(_req: Request, res: Response) {
    const result = this.debugService.resetStepSnapshotSession();
    return res.status(200).json(result);
  }
  ...
  async getLatestTrace(_req: Request, res: Response) {
    const result = await this.debugService.getLatestTrace();
    return res.status(200).json(result);
  }
  ...
  async downloadTrace(_req: Request, res: Response) {
    const { jsonl, filename } = await this.debugService.downloadTrace();
  ...
  async resetTrace(_req: Request, res: Response) {
    const result = this.debugService.resetTrace();
    return res.status(200).json(result);
  }
  ...
  async astResolvePath(req: Request, res: Response) {
    ...
    const result = await this.debugService.handleAstResolvePath(dto);
