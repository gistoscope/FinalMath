...
export const PRIMITIVES_V5_TABLE: PrimitivesTable = {
  ...
  rows: [
    ...
    },
    {
      ...
      notes:
        "Integer division with no remainder. Constraints: a,b,c ∈ ℤ; b≠0; a mod b = 0",
    },
    {
      ...
      notes:
        "Convert non-exact division to fraction. Constraints: a,b ∈ ℤ; b≠0; a mod b ≠ 0",
    },
    {
      id: "P.DECIMAL_DIV",
    ...
    },
    {
      ...
      notes:
        "Add numerators with same denominator. Constraints: a,c,b ∈ ℤ; b≠0",
    },
    {
      ...
      notes:
        "Subtract numerators with same denominator. Constraints: a,c,b ∈ ℤ; b≠0",
    },
    {
      id: "P.FRAC_MUL",
      domain: "fractions",
    ...
    },
    {
      ...
      notes:
        "Convert division to multiplication by reciprocal (Keep-Change-Flip)",
    },
    ...
    },
    {
      ...
      forbiddenGuards: ["is-decimal"],
      notes:
        "First step in creating equivalent fraction. Constraints: a,b \u2208 \u2124; b\u22600",
    },
    {
    ...
    },
    {
      ...
      notes:
        "Step 1: Multiply both fractions by 1. Constraints: a/b + c/d; b≠d",
    },
    {
    ...
    },
    {
      ...
      notes:
        "Remove unnecessary parentheses. Constraints: No operators outside",
    },
    {
    ...
    },
    {
      ...
      notes:
        "Distribute multiplication over addition. Constraints: a,b,c: int/frac",
    },
    {
      ...
      notes:
        "Distribute multiplication over subtraction. Constraints: a,b,c: int/frac",
    },
    {
      id: "P.FACTOR_ADD",
      domain: "algebra",
