...
import type { SelectedOutcome } from '../../primitive-master/provider/selector/selector.type.js';
...
export class V5OutcomeHandler {
  ...
  async handle(
    ...
    switch (v5Outcome.kind) {
      ...
      case 'blue-choice':
        return await this.handleBlueChoice(
          v5Outcome,
          req,
          clickTarget,
          history,
